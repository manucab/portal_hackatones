    ...
    return(
        ...
        <div className="createHackathon">
                ...
                <fieldset className="fieldDates">
                   ...
                   <label>Fecha inicio: <input type='date' min={today} defaultValue={today} name="start_date" onChange={e =>setStart_date(e.target.value)} required/></label>
                   <label>Fecha fin: <input type='date'min={start_date} name="end_date" onChange={e =>setEnd_date(e.target.value)} required /></label>
                </fieldset>

                <fieldset className="fieldState">
                    <legend>Estado</legend>
                    <label>Selecciona un estado: </label>
                    <Select id="hackathon_status" options={optionStatus} defaultValue={optionStatus[0]} onChange={handleStatusSelected} isDisabled required/>
                </fieldset>

               <div className="techs">
                   <fieldset>
                        <legend>Tecnologías</legend>
                        <CreatableSelect className="selectTechs" isMulti options={optionsTech} onChange={handleTechSelected}   />
                   </fieldset>
               </div>
               ...
               <div  className="links">
                    <fieldset id="fieldLinks">
                        ...
                        <div className="divLink">
                            ...
                            <label id="lblUrl">Url: <input type='url'  pattern="https://.*" value={webUrl}  name="url" onChange={handleWebUrl} placeholder="https://www.hackathonplay.com" /></label>
