...
const createHackathon = async(req, res) => {
    ...
    console.log('CreateHackathon ok');
    res.send('CreateHackathon ok');

    // 1. Get params
    const { place, city, start_date, end_date, id_organizer, hackathon_status, hackathon_info } = req.body

    console.log(place, city, start_date, end_date, id_organizer, hackathon_status, hackathon_info);
